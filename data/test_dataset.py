...
def make_dataset(root_path, subset, view, sample_duration, random_state, type=None):
    """
...
class DAC_Test(data.Dataset):
    ...
    def __init__(self,
        ...
        self.data = make_dataset(root_path=root_path, subset=subset, view=view, sample_duration=sample_duration, 
